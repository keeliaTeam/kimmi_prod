...
class MainActivity : FlutterActivity() {
    ...
    private fun openNotificationSettings() {
        ...
        try {
            ...
            intent.putExtra(Settings.EXTRA_APP_PACKAGE, "com.kimmi.imk")
            intent.putExtra(Settings.EXTRA_CHANNEL_ID, "com.kimmi.imk");
            startActivity(intent);
        } catch (e: Exception) {
            e.printStackTrace();
            val intent = Intent()
            intent.setAction(Settings.ACTION_APPLICATION_DETAILS_SETTINGS)
            intent.setData(Uri.fromParts("package", "com.kimmi.imk", null));
            startActivity(intent);
        }
    }
