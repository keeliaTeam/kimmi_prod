                  ...
                  child: GestureDetector(
                      onPanUpdate: (detail) {
                        logic.onKimmiEuropeEagerDrake(
                            MediaQuery.of(context).size, detail.delta);
                      },
                      child: BannerViewHelper.getBannerView(
                          scrollPhysics: const NeverScrollableScrollPhysics(),
                          logic.floatWindows!.urls.map((elem) {
                          ...
                          viewportFraction: 1,
                          aspectRatio: logic.floatWindows!.height /
