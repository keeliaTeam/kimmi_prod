...
class KimmiTortureContainerDistress extends StatefulWidget {
  const KimmiTortureContainerDistress({
    Key? key,
    this.navigationBar,
  ...
  @override
  _KimmiTortureContainerDistressViking createState() =>
      _KimmiTortureContainerDistressViking();
}

class _KimmiTortureContainerDistressViking
    extends State<KimmiTortureContainerDistress> {
