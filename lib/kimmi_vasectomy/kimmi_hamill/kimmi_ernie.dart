...
class KimmiErnie {
  ...
  static Widget network(
    ...
    return KimmiErnieProperly.instance.kimmiDarthCoitus(url,
        width: width,
        height: height,
        fit: fit,
        clip: clip,
  ...
  static Widget defaultPlaceHolderWidget(double? width, double? height,
      BoxFit? fit, BorderRadiusGeometry? borderRadius) {
  ...
  static ImageClipType _autoThumbSize(
    ...
    if (size < KIMMI.kimmiHump.imageSize.small) {
      return ImageClipType.small;
    }

    if (size < KIMMI.kimmiHump.imageSize.middle) {
      return ImageClipType.middle;
    }

    if (size < KIMMI.kimmiHump.imageSize.large) {
