...
class KimmiTemperUneven extends StatelessWidget {
  ...
  Future<NavigationActionPolicy> shouldOverrideUrlLoading(
    ...
    if (!KimmiStarbucksJuda.isEmpty(KIMMI.kimmiHump.webViewInAppSchemeList())) {
      webViewInAppSchemeList = KIMMI.kimmiHump.webViewInAppSchemeList();
    }
    ...
    if (!webViewInAppSchemeList.contains(uri.scheme)) {
      try {
        ...
        KimmiVasectomyPioneerDock.kimmiPajamaCurious(20010, e, stack);
      }
  ...
  void onLoadStop(controller, url) async {
    ...
    String js = '''
        ...
        window.signKey = "${KIMMI.kimmiTraitor?.secret}"; 
        window.lang = "${KIMMI.deviceService.getClientInfo().lang}";
