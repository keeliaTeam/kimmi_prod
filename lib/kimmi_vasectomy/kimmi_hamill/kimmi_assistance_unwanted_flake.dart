...
class KimmiAssistanceUnwantedFlake {
  ...
  void stopAfter(Duration delay) {
    _timer?.cancel();
    print(
      '[KimmiAssistanceUnwantedFlake] stopAfter called delay=${delay.inMilliseconds}ms, hasHandler=${_stopAfterHandler != null}',
    );
    ...
    _timer = Timer(delay, () {
      print(
        '[KimmiAssistanceUnwantedFlake] stopAfter timer fired, invoking stopAndCenter',
      );
      _stopAndCenterFn?.call();
    });
  }
