    ...
    return Center(
      child: Container(
        ...
        child: Column(
          ...
          children: [
            14.hGap,
            Text("kimmi_broderick_eyelash_scrap_doggy_lassie".tr,
                style: KimmiTamperDaytime.style(
                    color: "651FFF".toColor(),
                    fontSize: 24,
                    fontWeight: FontWeight.w500)),
            8.hGap,
            Text("kimmi_broderick_eyelash_intoxicate_cape_doggy".tr,
                style: KimmiTamperDaytime.style(
            ...
            Container(
                height: 72,
                decoration: BoxDecoration(
                    borderRadius: 12.rectBg, color: KimmiDraftJuda.black_05p),
                child: Stack(
                  children: [
                    Align(
            ...
            20.hGap,
            Text("kimmi_broderick_cabernet".tr,
