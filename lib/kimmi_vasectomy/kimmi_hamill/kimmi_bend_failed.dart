...
class KimmiBendFailed extends StatefulWidget {
  final Widget child;
  ...
  final KimmiBendFlake? controller;

  const KimmiBendFailed({
    Key? key,
    required this.child,
    this.minScale = 0.9,
    this.maxScale = 1.0,
  ...
  @override
  _KimmiBendFailedViking createState() => _KimmiBendFailedViking();
}

class _KimmiBendFailedViking extends State<KimmiBendFailed>
  ...
  @override
  void didUpdateWidget(covariant KimmiBendFailed oldWidget) {
