...
class KimmiFailedBerryMeaning extends StatefulWidget {
  ...
  @override
  State<KimmiFailedBerryMeaning> createState() =>
      _KimmiFailedBerryMeaningViking();
}

class _KimmiFailedBerryMeaningViking extends State<KimmiFailedBerryMeaning>
    ...
    if (!init) {
      ...
      Future.delayed(const Duration(seconds: 1), () {
        ...
        try {
          ...
          KimmiVasectomyPioneerDock.kimmiPajamaCurious(10096, e, stack);
          return;
        }
      });
    } else {
