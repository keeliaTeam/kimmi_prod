...
import 'kimmi_muse_procedure.dart';

class KimmiWaitressExpensiveSouthPhone {
  int? category;
  int? type;
  String? title;
  String? desc;
  ...
  bool get isUserIdMine => userId == KIMMI.uid();
    ...
    if (content?.category != null) {
      switch (ChatSnapJsonContentCategory.valueOf(content!.category)) {
        case ChatSnapJsonContentCategory.callCate:
          switch (content.type) {
            case ChatSnapJsonContentType.callRating:
              ret = "kimmi_broderick_stimulate_basket".tr;
              break;
            case ChatSnapJsonContentType.callAudio:
            case ChatSnapJsonContentType.callVideo:
              ret = "kimmi_broderick_india_doggy_basket".tr;
              break;
            default:
              break;
          }
          break;
        case ChatSnapJsonContentCategory.imGiftCate:
          ret = "kimmi_broderick_latino_basket".tr;
          break;
        default:
          break;
      }
