...
class KimmiStormBoatTux {
  ...
  factory KimmiStormBoatTux.fromJson(Map<String, dynamic> json) {
    return KimmiStormBoatTux()
      ...
      ..vm = KimmiKeyboardJuda.intDef(json, "vm", 0)
      ..px_ratio = KimmiKeyboardJuda.doubleDef(json, "px_ratio", 0)
      ..low_mem = KimmiKeyboardJuda.intDef(json, "low_mem", 0);
  }
