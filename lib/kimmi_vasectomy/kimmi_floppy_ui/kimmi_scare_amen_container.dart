...
class KimmiScareAmenContainer
    ...
    if (!KimmiStarbucksJuda.isEmptyList(balanceList)) {
      ...
      for (KimmiDeportFlaunt option in balanceList!) {
        if (option.account_type == 1 && option.group_id == 1) {
          children.add(
            _kimmiTraditionFinallyMomentum(context, option, payEvent: () {
    ...
    children.add(GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return _kimmiScareApplicantMomentumUneven(
            context, data, index, pays.length);
      },
    ));
    return Positioned(
      left: 0,
  ...
  Widget _kimmiScareApplicantMomentumUneven(
      BuildContext context, KimmiDeportFlaunt? data, int index, int count) {
        ...
        child: ListView.separated(
          ...
          itemBuilder: (context, index) {
            ...
            return data.group_id == 1
                ? _kimmiTraditionFinallyMomentum(context, data, payEvent: () {
                    logic.onKimmiTowComponent(data);
                  })
                ...
                Column(
                  ...
                  children: [
                    Expanded(
                      child: Padding(
                        padding:
                            const EdgeInsets.only(top: 10, left: 20, right: 16),
                        child: Row(
                          children: [
                            KimmiErnie.local(
                        ...
                        children: [
                          ...
                          Transform.rotate(
                              ...
                              child: KimmiErnie.local(
                                  fileName:
                                      'kimmi_hombre_wit_category_comprehend',
                                  width: 12,
                                  height: 12)),
                        ],
                      ),
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: KimmiTamperDaytime.style(
                                color: KimmiDraftJuda.white_50p, fontSize: 11),
                          ),
                        ],
                      )
                    ],
