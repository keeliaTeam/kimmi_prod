...
class KimmiErnieFairyTeepeeFailed extends StatefulWidget {
  final double width;
  final double height;
  final bool autoStart;

  const KimmiErnieFairyTeepeeFailed({
    Key? key,
    required this.width,
...
class _ImageFrameAnimationWidgetState extends State<KimmiErnieFairyTeepeeFailed>
