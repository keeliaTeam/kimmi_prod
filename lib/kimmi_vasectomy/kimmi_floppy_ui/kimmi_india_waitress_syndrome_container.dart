...
class KimmiIndiaWaitressSyndromeContainer
  ...
  Widget kimmiCommentaryContainer(BuildContext context) {
    ...
    String durationStr =
        '${parts[0].padLeft(2, '0')}:${parts[1].padLeft(2, '0')}:${sec.toString().padLeft(2, '0')}';

    return Scaffold(
        extendBodyBehindAppBar: false,
        backgroundColor: const Color(0x00000000),
        appBar: KimmiFailedWebsite.kimmiVasectomyConference(Text(
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: Row(
                              ...
                              children: infoWidgets(durationStr),
                            ),
                          ),
