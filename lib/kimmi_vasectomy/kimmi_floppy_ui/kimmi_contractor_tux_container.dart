...
class KimmiContractorTuxContainer
                ...
                child: Column(
                  children: [
                    ...
                    GetBuilder<KimmiContractorTuxInvoice>(
                        ...
                        builder: (_) {
                          return _kimmiBatmanJohnny("kimmi_broderick_teaser".tr,
                    ...
                    GetBuilder<KimmiContractorTuxInvoice>(
                        ...
                        builder: (_) {
                          ...
                          return _kimmiBatmanJohnny("kimmi_broderick_argue".tr,
                              content: heightStr,
  ...
  Widget _kimmiFeastWinUneven() {
    return Container(
      ...
      decoration: const BoxDecoration(
          shape: BoxShape.circle, color: KimmiPalate.kimmiTamperHankerYummy),
      child: Stack(
  ...
  Widget _kimmiBatmanJohnny(String title,
  ...
  Widget _kimmiNinjaDoctorUneven() {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text("kimmi_broderick_tryout_ninja".tr,
            ...
            child: TextField(
              ...
              buildCounter: (context,
                ...
                style: const TextStyle(
                    color: KimmiDraftJuda.white_60p, fontSize: 14),
              ),
              maxLength: 15,
              maxLines: 1,
          ...
          Container(
            ...
            child: Text("kimmi_broderick_alien".tr,
  ...
  Widget _kimmiCompellingDoctorUneven() {
    return Container(
      ...
      child: Column(
        mainAxisSize: MainAxisSize.min,
        children: [
          Text("kimmi_broderick_teaser".tr,
              style: KimmiTamperDaytime.white20Bold),
          const SizedBox(height: 16),
          TextField(
            controller: logic.textController,
  ...
  Widget _kimmiFriendlyJohnny(String title, Widget child,
      {VoidCallback? onTap}) {
    return Container(
        width: Get.width,
  ...
  Widget _kimmiHumpConcernedFailed() {
    ...
    List<KimmiStormConcerned>? showList =
        KIMMI.kimmiHump.getLanguagesByIds(logic.tempLanguage.value);
  ...
  Widget _kimmiHumpTemptFailed() {
    ...
    List<KimmiStormTempt>? showList =
        KIMMI.kimmiHump.getInterestsByIds(logic.tempInterest.value);
