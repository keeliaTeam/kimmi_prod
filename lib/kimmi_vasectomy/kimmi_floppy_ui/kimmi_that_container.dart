...
class KimmiThatContainer extends KimmiMuseIdolizeContainer<KimmiThatInvoice> {
  ...
  _kimmiThatMakeFailed(String title, String value) {
    return Column(mainAxisAlignment: MainAxisAlignment.center, children: [
      Text(title,
          style: KimmiTamperDaytime.style(
              fontSize: 12, color: KimmiDraftJuda.white_40p)),
      Text(value,
          style: KimmiTamperDaytime.style(
              fontSize: 14,
              fontWeight: FontWeight.bold,
  ...
  Positioned _kimmiMatadorIndiaBg() {
    return Positioned(
        ...
        bottom: 0,
        child:
            !KimmiStarbucksJuda.isEmpty(logic.matchUser.value.video!.videoUrl)
                                  ...
                                  Expanded(
                                    child: Text(
                                        'kimmi_broderick_india_donut_store_music'
                                            .tr,
                                        style:
                                            KimmiTamperDaytime.black14_Medium),
                                  ),
          ...
          Positioned(
              ...
              child: Container(
                ...
                child: Row(mainAxisSize: MainAxisSize.min, children: [
                  Text('kimmi_broderick_thought'.tr,
                      style: KimmiTamperDaytime.white16Bold),
                  KimmiErnie.local(
                      fileName: isAR
        ...
        child: Column(
          ...
          children: [
                ...
                return Row(
                  children: [
                    ConstrainedBox(
                        ...
                        child: Text(logic.matchUser.value.user!.nickName,
                            style: KimmiTamperDaytime.style(
                                color: KimmiDraftJuda.white,
                                fontSize: 24,
                                fontWeight: FontWeight.bold),
            ...
            KIMMI.kimmiHump.isKimmiHeartTyler()
                ...
                : Row(
                    children: [
                      Text(logic.matchUser.value.user!.price.toString(),
                          style: KimmiTamperDaytime.style(
                              fontSize: 14,
                              fontWeight: FontWeight.bold,
                              color: KimmiDraftJuda.white)),
