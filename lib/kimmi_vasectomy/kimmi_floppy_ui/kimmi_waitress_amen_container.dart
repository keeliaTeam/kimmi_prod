...
import '../kimmi_hamill/kimmi_muse_container_sun.dart';
  ...
  Widget _kimmiWaitressTotallyPer(KimmiWaitressTotally chatBox) {
    return Material(
      ...
      child: Slidable(
        ...
        child: InkWell(
          onTap: () => KIMMI.toNamed(KimmiSully.KimmiWaitressContainer,
            ...
            children: [
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  Expanded(
                      child: Text("kimmi_broderick_smile_maker".tr,
...
class KimmiWaitressDoublePer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          KimmiErnie.local(
              fileName: chatCustomData.icon ?? "", width: 56, height: 56),
  ...
  Widget _kimmiWaitressDoublePerTamperFailed() {
    return Expanded(
        child: Text(chatCustomData.content ?? "",
            maxLines: 1,
