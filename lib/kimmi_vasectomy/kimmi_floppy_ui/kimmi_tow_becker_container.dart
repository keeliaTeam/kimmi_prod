...
class KimmiTowBeckerContainer
        ...
        children: [
          ...
          GetBuilder<KimmiTowBeckerInvoice>(
            ...
            builder: (logic) {
              ...
              return Visibility(
                  visible: length > 0,
                  child: Text('kimmi_broderick_heartbreak_deport_sophomore'.tr,
                      style: KimmiTamperDaytime.style(
                          color: KimmiDraftJuda.black_40p, fontSize: 16)));
            },
          ),
              ...
              Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: KimmiTamperDaytime.style(
                        fontSize: 14, color: KimmiDraftJuda.black_60p),
                  )
                ],
              )
            ],
          ...
          Positioned(
              ...
              child: Visibility(
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      Text("+${optionDetail.extra_value.toStringAsFixed(0)}",
                          style: KimmiTamperDaytime.style(
                              color: KimmiDraftJuda.white,
                              fontWeight: FontWeight.bold,
                              fontSize: 12)),
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                KimmiErnie.local(
                                    fileName:
                                        'kimmi_hombre_tow_fellow_med_gloss',
                                    width: 14,
                                    height: 14),
                                const SizedBox(width: 2),
        ...
        itemBuilder: (context, index) {
          return GestureDetector(
            ...
            child: _kimmiCommentaryMomentum(
                context, optionDetail.pay_mode_prices![index], optionDetail),
          );
        },
      ),
    ));
  ...
  Widget _kimmiCommentaryMomentum(BuildContext context,
      KimmiDeportSophomore paymentMethod, KimmiDeportFlaunt optionDetail) {
    return Container(
            ...
            child: Row(
                ...
                children: [
                  Row(
                    children: [
                      KimmiErnie.circle(
                          url: paymentMethod.icon ?? "", size: 32),
