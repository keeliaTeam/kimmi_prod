...
class KimmiStretchByeWealthy extends StatefulWidget {
  ...
  const KimmiStretchByeWealthy(this.dataSource, {Key? key}) : super(key: key);

  @override
  State<KimmiStretchByeWealthy> createState() {
    return _KimmiStretchByeWealthyViking();
  }
}

class _KimmiStretchByeWealthyViking extends State<KimmiStretchByeWealthy> {
