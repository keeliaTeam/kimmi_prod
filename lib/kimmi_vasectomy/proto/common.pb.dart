...
class CommonRsp extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo(
        ...
        ..a<$core.int>(
          3,
          _omitFieldNames ? '' : 'originalMsgCate',
          $pb.PbFieldType.OU3,
        )
        ..a<$core.int>(
          4,
          _omitFieldNames ? '' : 'originalMsgType',
          $pb.PbFieldType.OU3,
        )
...
class CommonServiceErr extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo(
        ...
        ..aOM<$0.Any>(
          2,
          _omitFieldNames ? '' : 'originalMessage',
...
class UserRuntimePSH extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo(
        ...
        ..a<$core.int>(
          4,
          _omitFieldNames ? '' : 'hadPaid',
          $pb.PbFieldType.O3,
          protoName: 'hadPaid',
        )
        ..a<$fixnum.Int64>(
          5,
          _omitFieldNames ? '' : 'vipExpire',
          $pb.PbFieldType.OU6,
          protoName: 'vipExpire',
          defaultOrMaker: $fixnum.Int64.ZERO,
        )
