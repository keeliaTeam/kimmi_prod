...
class BegGiftReq extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo(
        ...
        ..a<$fixnum.Int64>(
          2,
          _omitFieldNames ? '' : 'toUid',
          $pb.PbFieldType.OU6,
          defaultOrMaker: $fixnum.Int64.ZERO,
        )
        ..a<$core.int>(
          3,
          _omitFieldNames ? '' : 'sceneType',
          $pb.PbFieldType.OU3,
        )
        ..a<$fixnum.Int64>(
          4,
          _omitFieldNames ? '' : 'sceneId',
          $pb.PbFieldType.OU6,
          defaultOrMaker: $fixnum.Int64.ZERO,
        )
        ..hasRequiredFields = false;
...
class BegGiftPSH extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo(
        ...
        ..aOM<$1.Gift>(
          1,
          _omitFieldNames ? '' : 'gift',
          subBuilder: $1.Gift.create,
        )
        ..a<$fixnum.Int64>(
          2,
          _omitFieldNames ? '' : 'fromUid',
          $pb.PbFieldType.OU6,
          defaultOrMaker: $fixnum.Int64.ZERO,
        )
        ..a<$core.int>(
...
class CheckCallRsp extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo(
        ...
        ..a<$core.int>(
          5,
          _omitFieldNames ? '' : 'firstPay',
          $pb.PbFieldType.OU3,
        )
        ..a<$core.int>(
          6,
          _omitFieldNames ? '' : 'noDisturb',
          $pb.PbFieldType.OU3,
        )
        ..a<$core.int>(
          7,
          _omitFieldNames ? '' : 'hasExpCard',
          $pb.PbFieldType.OU3,
        )
        ..a<$core.int>(
          8,
          _omitFieldNames ? '' : 'onlineStatus',
          $pb.PbFieldType.OU3,
        )
        ..a<$core.int>(
          9,
...
class ChatCallMatchRsp extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo(
        ...
        ..a<$core.int>(
          6,
          _omitFieldNames ? '' : 'remainCount',
          $pb.PbFieldType.OU3,
        )
        ..a<$core.int>(
          7,
          _omitFieldNames ? '' : 'limitCount',
          $pb.PbFieldType.OU3,
        )
        ..hasRequiredFields = false;
  ...
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo(
        ...
        ..aOM<VideoPlaySummary>(
          7,
          _omitFieldNames ? '' : 'videoPlaySummary',
...
class VideoPlaySummary extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo(
        ...
        ..a<$core.int>(
          1,
          _omitFieldNames ? '' : 'preBufferDuration',
          $pb.PbFieldType.OU3,
        )
        ..a<$core.int>(
          2,
          _omitFieldNames ? '' : 'bufferingTimes',
          $pb.PbFieldType.OU3,
        )
        ..a<$core.int>(
          3,
          _omitFieldNames ? '' : 'bufferingTotalDuration',
          $pb.PbFieldType.OU3,
        )
        ..a<$core.int>(
          4,
          _omitFieldNames ? '' : 'closeType',
          $pb.PbFieldType.OU3,
        )
        ..a<$core.int>(
          5,
